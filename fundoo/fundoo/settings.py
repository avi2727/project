...
EMAIL_HOST_USER = 'avinashshukla3012@gmail.com'   # email to be send from user
EMAIL_HOST_PASSWORD = 'golusmile@105'                   # password
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'avismile',
        'HOST': 'avidatabase1.cqnrioei1gw1.ap-south-1.rds.amazonaws.com',
        'PORT': '5432',
    }
}
